...
.ap-h1 b { 
  font-weight:700; 
  color:#2D6A4F;       /* make auctions black too */
}
       .ap-sub { 
  font-size:15px; 
  ...
  margin-bottom:32px; 
       ...
       .sinput::placeholder {
        ...
        .sec-count {
          font-size:10.5px; color:#374151; background:#F3F4F6;
        ...
        .ac.ended-card { opacity:0; filter:saturate(0.5); }
        .ac.ended-card:hover { filter:saturate(0.75); }
        ...
        .ac-time { font-size:11.5px;  color:#1F2937;
                font-weight:400; text-align:right; line-height:1.5; 
                }
